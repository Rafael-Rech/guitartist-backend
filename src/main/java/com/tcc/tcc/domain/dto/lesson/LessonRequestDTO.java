...
public class LessonRequestDTO {
    ...
    public LessonRequestDTO(ESubject subject, short id, ELessonType type) {
    ...
    public LessonRequestDTO(ESubject subject, short id, ELessonType type, short numberOfTries, short averagePrecision,
            short proficiency) {
        this.subject = subject;
        this.id = id;
        this.type = type;
